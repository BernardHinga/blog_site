...
<head>
    <title>Shesonpurpose.com</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <link href="https://fonts.googleapis.com/css?family=Josefin+Sans:300,400,700|Inconsolata:400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Alegreya&family=Cinzel&family=Patrick+Hand&family=Rokkitt:wght@200;300&display=swap" rel="stylesheet">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("Submit").click(function() {
                numComments = numComments+3;
                $("#comments").load("includes/load-comments.php", {
                    NewnumComments: newComments
                });
            });
        });
    </script> -->
    ...
    <div class="wrap">
            ...
            <div class="container logo-wrap">
                <div class="row pt-5">
                    <div class="col-12 text-center">
                        ...
                        <h1 class="site-logo"><a href="index.html">SHE'S<span style="color: #a70000">ON</span>PURPOSE</a></h1>
                    </div>
                </div>
            </div>
            <!--== header ending ==-->
                    ...
                    <div class="col-md-12 col-lg-8 main-content">
                        ...
                        <div class='pt-5' id="comments"> 
                            ...
                            <div class='comment-form-wrap pt-5'>
                                ...
                                <?php
                                echo "<form action='".setComment($conn)."' method='POST' class='p-5 bg-light'>
                                    ...
                                    <div class='form-group'>
                                        <input type='submit' name='Submit' value='Post Comment' class='btn btn-primary btn-sm rounded'>
                                    </div>
                                </form>"
                                ?>
                            </div>
                    ...
                    <div class="col-md-12 col-lg-4 sidebar">
                        ...
                        <div class="sidebar-box">
                            <div class="bio text-center">
                                <img src="images/owner.jpg" alt="Image Placeholder" class="img-fluid">
                                <div class="bio-body">
                                    <h2>Mercy</h2>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-4">
                        <h3><span style="color: #ff0000;text-decoration: underline;">About Us</span></h3>
                        <p class="mb-4">
                    ...
                    <div class="col-md-6 ml-auto">
                        <div class="row">
                            <div class="col-md-7">
                                <h3><span style="color: #ff0000;text-decoration: underline;">Latest Post</span></h3>
                                <div class="post-entry-sidebar">
                                    <ul>
                                        <li>
                                            <a href="">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-5">
                                    <h3><span style="color: #ff0000;text-decoration: underline;">QUICK LINKS</span></h3>
                                ...
                                <div class="mb-5">
                                    <h3><span style="color: #ff0000;text-decoration: underline;">Social</span></h3>
